...
TEST(Unicode, Test1)
{
    using   U8ToU16 = utf::UniFy<char16_t, char8_t>;
    using   U16ToU32 = utf::UniFy<char32_t, char16_t, false, false>;
    using   U32ToU8 = utf::UniFy<char8_t, char32_t, false, false>;
    ...
    char32_t uc_data1[1040 * 10] = {0,};
    auto [size1, length1] = U16ToU32::transcode(uc_data1, uc_data, size);

    char8_t uc_data2[1040 * 10] = {0,};
    auto [size2, length2] = U32ToU8::transcode(uc_data2, uc_data1, size1);

    std::cout << "Processed Size: " << size2 << "\n";

    std::for_each(uc_data2, uc_data2 + size2, [](char8_t& value){ std::cout << static_cast<char>(value); });

...
int main(int argc, char** argv)
{
    ...
    using   UnicodeBB   = utf::UniFy<char32_t, char8_t, true, true>;
    using   UnicodeBL   = utf::UniFy<char32_t, char8_t, false, true>;
    using   UnicodeLB   = utf::UniFy<char32_t, char8_t, true, false>;
